...
url = 'https://api.basespace.illumina.com/v2/biosamples?projectid=%s&access_token=%s&limit=1000' % (
    projectid, AccessToken)
json_obj = restrequest(url)
...
url = 'https://api.basespace.illumina.com/v2/datasets?inputbiosamples=%s&access_token=%s' % (
    samplecsv, AccessToken)
...
for index in range(noffsets):
    offset = 1000*index
    url = 'https://api.basespace.illumina.com/v2/datasets?inputbiosamples=%s&access_token=%s&limit=1000&Offset=%s' % (
